...
This file should be placed in your `Hero` folder, alongside the `__main__.py` file . 
...
```
from Hero.sample_config import Config


class Development(Config):
    OWNER_ID = *********  # my telegram ID
    OWNER_USERNAME = "xyz"  # my telegram username
