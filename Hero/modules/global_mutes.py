...
import Hero.modules.sql.global_mutes_sql as sql
from Hero import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE
from Hero.modules.helper_funcs.chat_status import user_admin, is_user_admin
from Hero.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Hero.modules.helper_funcs.filters import CustomFilters
from Hero.modules.helper_funcs.misc import send_to_list
from Hero.modules.sql.users_sql import get_all_chats
